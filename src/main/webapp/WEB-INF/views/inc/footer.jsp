                    ...
                    <div class="col-lg-8">
                        <div class="footer_menu">
                            <div class="footer_logo">
                                <a href="${contextPath}/index.tem"><img src="${contextPath}/resources/img/logo.png" alt="#"></a>
                            </div>
                            <div class="footer_menu_item">
                                <a href="${contextPath}/index.tem">Home</a>
                                <a href="${contextPath}/about.tem">About</a>
                                <a href="${contextPath}/productlist.tem">Products</a>
                                <a href="#">Pages</a>
                                <a href="${contextPath}/blog.tem">Blog</a>
                                <a href="${contextPath}/contact.tem">Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
